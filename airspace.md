...
此外，VATPRC目前暂时代管蒙古国的ZMUB Ulaanbaatar 乌兰巴托情报区。


注意：
+ VATSIM 对于情报区划分并不一定与真实世界中的情报区划分完全一致。为避免争议，上述示意图仅为 VATPRC 主要管辖范围。请勿误将其当作真实中的情报区划分。

+ VATPRC并不管辖香港飞行情报区（VHHK，Hong Kong FIR）和台北飞行情报区（RCAA，Taipei FIR）。二者分别由VATSEA下属的HKvACC以及VATROC进行管辖。在上述两个飞行情报区内飞行时，管制员将不支持中文管制，且空域运行标准规范均与内地有很大不同。
...
+ 北京飞行情报区（ZBPE）包含：北京区域管制区*（服务由北京区域管制中心和太原区域管制室提供，具体视扇区而定）、呼和浩特区域管制区（服务由呼和浩特区域管制室提供）

+ 广州飞行情报区（ZGZU）包含：广州区域管制区（服务由广州区域管制室提供）、南宁区域管制区（服务由南宁区域管制室提供）、长沙区域管制区（服务由长沙区域管制室提供）

+ 昆明飞行情报区（ZPKM）包含：成都区域管制区**（服务由成都区域管制室和重庆区域管制室提供，具体视扇区而定）、贵阳区域管制区（服务由贵阳区域管制室提供）、昆明区域管制区（服务由昆明区域管制室提供）、拉萨区域管制区（服务由拉萨区域管制室提供）

+ 兰州飞行情报区（ZLHW）包含：兰州区域管制区（服务由兰州区域管制室提供）、西安区域管制区（服务由西安区域管制室提供）

+ 三亚飞行情报区（ZJSA）包含：三亚区域管制区（服务由三亚区域管制室提供）

+ 上海飞行情报区（ZSHA）包含：合肥区域管制区（服务由合肥区域管制室提供）、济南区域管制区（服务由济南区域管制室提供）、南昌区域管制区（服务由南昌区域管制室提供）、青岛区域管制区***（服务由青岛区域管制室和大连区域管制室提供，具体视扇区而定）、南昌区域管制区（服务由南昌区域管制室提供）、厦门区域管制区（服务由厦门区域管制室提供）、上海区域管制区****（服务由上海区域管制室提供）

+ 沈阳飞行情报区（ZYSH）包含：大连区域管制区（服务由大连区域管制室提供）、哈尔滨区域管制区（服务由哈尔滨区域管制室提供）、沈阳区域管制区（服务由沈阳区域管制室提供）

+ 乌鲁木齐飞行情报区（ZWUQ）包含：乌鲁木齐飞行情报区（服务由乌鲁木齐区域管制室提供）

+ 武汉飞行情报区（ZHWH）包含：武汉区域管制区（服务由武汉区域管制室提供）、郑州区域管制区（服务由郑州区域管制室提供）
