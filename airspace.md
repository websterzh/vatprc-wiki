...
在管制空域进行飞行时，请信任当班管制员，仔细守听并正确执行管制员所发布的指令。管制员和机组之间是相互包容、相互理解的和谐关系，当管制员状态欠佳时，还请机组理解。VATPRC所有的管制员在放单前都接受过严格的训练，因此他们有资质有能力提供对应的管制服务。有关管制员团队的具体信息请参看VATPRC管制员列表（https://www.vatprc.net/en/controller-list-en ）。
