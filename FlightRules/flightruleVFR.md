...
国外的VFR飞行比国内要更灵活，一般来说，您不需要严格地在飞行计划中写出详细的航路。部分国家的VFR法规也更完善、体系更健全，您需要查询熟读航图，并确保可以执行管制员指令。

由于本章内容容量原因，并且世界上不同地方VFR飞行的差别较大，本章内容不再对其他国家或地区的VFR飞行进行介绍。虽说如此，但是上文中所提到的“飞行中”里面的相关内容，仍然适用。

不同国家或地区对于空域、天气和VFR的飞行高度和最高高度要求不尽相同，例如：

+ 绝大部分国家存在非管制空域/半管制空域，在这些空域内飞行，可以联系相应管制员或情报席获取信息，也可以不联系；
+ 一般来说，3000英尺以上，VFR飞行高度在IFR飞行高度的基础上加500英尺，例如向东飞行可以使用5500英尺。
