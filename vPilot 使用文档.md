...
请注意，如果您的PTT使用的是键盘按键，当您以管理员身份运行 FSX/P3D/MSFS时，必须同样以管理员身份运行 vPilot 才可以保证vPilot正确识别该按键。
...
在这里，您可以选择让 vPilot 在您的航空器离地时自动开启应答机的C 模式。如果您的航空器集成有 SquawkBox 转发器，则应不选中此复选框，因为 vPilot 将能够直接从航空器面板读取应答机模式。
...
1. ![QQ图片20220427232916](https://user-images.githubusercontent.com/104274235/165555132-4fe12d80-d3f1-4ffa-a5d4-cf5f8c632eb8.png)
...
> *解决方法：如偶尔出现，可无需在意；但如果较为频繁，那么请首先请检查您网络是否存在丢包等现象，若您的网络正常，一般是由于国内的网络环境引起，通常使用加速器可以解决。*


2. ![QQ图片20220425141139](https://user-images.githubusercontent.com/104274235/165033691-e1cc4360-7cf1-4b33-a983-9a2d1fa19579.png)
...
3. ***需要VATSIM连接失败图片，学校网络最近出奇稳定 做不到***

此段文字意为：
- 因网络问题，驳回连接请求

> *解决方法：可以尝试重启 vPilot ，如果仍然无法连接，那么首先请检查您网络是否存在丢包等现象，若您的网络正常，一般是由于国内的网络环境引起，通常使用加速器可以解决。*

4. ![QQ图片20220427233213](https://user-images.githubusercontent.com/104274235/165555664-14b9b65d-6d92-4196-8511-a7fd3902255d.png)
...
5. ![QQ图片20220427233624](https://user-images.githubusercontent.com/104274235/165564820-4cb1f321-0873-4d43-92a1-4100e441a2e7.png)
