...
请机组尽可能的使用现实中 **真实存在** 或 **真实存在过** 亦或是  **VATSIM 官方批准的虚拟航空公司** 呼号连线，对于 **现实中不存在的**、**现实中未曾存在过的**、或 **未经过 VATSIM 官方批准的虚拟航空公司** 呼号，管制员可不承认其呼号。参见 VATSIM 批准的虚拟航空公司[列表](https://my.vatsim.net/virtual-airlines)。

阅读下方列表时，可合理使用浏览器中的 <kbd>Ctrl</kbd> + <kbd>F</kbd> 快捷键调出搜索框快速找到相应的呼号。
...
注意，中文呼号（如有）仅限中文通话时使用，在不可以使用中文通话的空域请使用英文呼号。即使在线管制员为 VATPRC 管制员，也应该使用英文进行陆空通话。
...
| BFK      | 内蒙古北方快线通用航空       | 快线     | Northern Express  |
...
| CAL      | 中华航空(China Airlines)                        | 华航/中华     | Dynasty     |
...
## 虚拟航空
下列列表列出的是来自在VATSIM注册，并且通过VATSIM认证的虚航。

（列表以myVATSIM Virtual Airlines板块的默认排序进行排列，无先后之分）

若您要加入相关虚航，您可在[该链接](https://my.vatsim.net/virtual-airlines#multiCollapseExample1)找到对应航司的官网，并按各自航司的要求进行注册。
| ICAO代码 | 航司名称（中英文） | 中文呼号 | 英文呼号 |
| --- | --- | --- | --- |
| DKH | 虚拟吉祥航空 DKHVirtual | 吉祥 | Air Juneyao |
| OVO | 海岸航空 MEDIUM5 VA | 五维 | Jellyfish |
| CCA | 虚拟中国国际航空  Virtual Air China | 国航 | Air China |
| CES | 虚拟中国东方航空 Virtual China Eastern | 东方 | China Eastern |
| CSN | 虚拟中国南方航空  Virtual China Southern Airlines | 南方 | China Southern |
| CJH | 菊花航空 Virtual Chrysanthemum Airlines | 菊花 | Chrysant |
| HAZ（货运：HZC） | 杭州航空  Virtual Hangzhou Airlines | 钱塘（货运：天杭） | Hangzhou (Cargo:Hangzhou Cargo)|
| CQH | 虚拟春秋航空 Virtual Spring Airlines | 春秋 | Air Spring |